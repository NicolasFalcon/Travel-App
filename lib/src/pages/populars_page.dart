...
class PopularsPage extends StatefulWidget {
  final Popular populars;

  PopularsPage({this.populars});

  @override
  _PopularsPageState createState() => _PopularsPageState();
}

class _PopularsPageState extends State<PopularsPage> {
            ...
            Stack(
              children: <Widget>[
                ColorFiltered(
                  ...
                  child: Hero(
                    tag: widget.populars.image,
                    child: Container(
                      height: 350,
                      width: MediaQuery.of(context).size.width,
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage(widget.populars.image),
                        ...
                        children: <Widget>[
                          ...
                          Text(',',
                              style:
                                  TextStyle(color: Colors.white, fontSize: 20)),
                          SizedBox(width: 10),
                          Text(widget.populars.country,
                              style:
                                  TextStyle(color: Colors.white, fontSize: 20)),
                        ],
                      ),
                      SizedBox(height: 10),
                      _buildStarsRating(widget.populars.rating)
                    ],
                  ),
                ),
                Stack(
